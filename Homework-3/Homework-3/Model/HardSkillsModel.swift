...
extension HardSkillsModel {
    init(
        ...
        self.hardSkill4 = "→ Git"
        self.howLongHaveBeenProgramming = "→ Изучвю Swift и разработку под IOS в общей сложности 8 месяцев./nЭто самое интересное для меня направление - рабработка мобильных приложения под IOS!"
        self.whatIexpextFromTheShiftCourses = "→ На обучении хочу повысит экспертизу. Буду рада сотрудничеству с ЦФТ в ФинТех."
    }
}
